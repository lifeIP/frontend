        ...
        <Center>
            ...
            <Card sx={{ borderRadius: "12px", width: "51.05vw", minHeight: "100px", marginBottom: '1.85vh' }}>
                <CardContent>
                    ...
                    <iframe src="https://vkvideo.ru/video_ext.php?oid=-30101930&id=456244614&hd=2&autoplay=1" width="100%" height="480" allow="autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock;" frameborder="0" allowfullscreen></iframe>
                </CardContent>
            </Card>
        </Center>
    );
